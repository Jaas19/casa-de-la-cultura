    ...
    <div class="activity px-10 py-14 flex flex-wrap justify-evenly gap-y-14">
        ...
        <x-activity>
            <x-slot name="title">{{ $activity->name }}</x-slot>
                ...
                @else
                    <li data-activity-id="{{ $activity->id }}" class="starting-date">Fecha de inicio:</span> {{ $activity->starting_date }}</li>
                    <li data-activity-id="{{ $activity->id }}" class="ending-date">Fecha de fin:</span> {{ $activity->ending_date }}</li>
                    <li>Hora de inicio:</span> {{ $activity->starting_time }}</li>
                    <li>Hora de fin:</span> {{ $activity->ending_time }}</li>
                @endif
